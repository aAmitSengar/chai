...
export default class AddToDesktop extends Component {
	constructor(props) {
		super(props);
		this.state = {
			showBanner: true,
		...
		return (
			<div>
				...
				<div className="ios-prompt">
					...
					<p onClick={this.addToGomeScreenIOS}>
						To install this Web App in your iPhone/iPad press
						<img src="logo1.png" alt="add" width="25px" height="25px" /> and then Add to Home Screen.
					</p>
				</div>
			</div>
		);
