...
class Layout extends Component {
    ...
    prepareLayout() {
        ...
        let notLogin = (this.props.location.pathname !== '/login' && this.props.location.pathname !== '/' && this.props.location.pathname !== '/forgot' && this.props.location.pathname.slice(0, 14) !== '/resetPassword')
        if (notLogin) {
            return (
